...
flags.DEFINE_integer("OPER_FLAG", 1, "the flag of opertion: 0 is for training ")
flags.DEFINE_string("path" , '../data/cifar10', "the path of training data, for example /home/hehe/celebA/")
flags.DEFINE_integer("batch_size", 16, "batch size")
flags.DEFINE_integer("max_iters", 3000, "the maxmization of training number")
flags.DEFINE_float("learn_rate", 0.0001, "the learning rate for G and D networks")
flags.DEFINE_float("flag", 1, "the FLAG of gan training process")
...
if __name__ == "__main__":
    ...
    if OPER_FLAG == 1:
        ...
        t = False
        pggan_checkpoint_dir_write = "./model_pggan_{}/{}/".format(OPER_FLAG, fl[0])
        sample_path = "./PGGanCifar10/{}/sample_{}_{}".format(FLAGS.OPER_FLAG, fl[0], t)
        mkdir_p(pggan_checkpoint_dir_write)
        mkdir_p(sample_path)
        pggan_checkpoint_dir_read = "./model_pggan_{}/{}/".format(0, r_fl[0])
        ...
        pggan = PGGAN(batch_size=batch_size, max_iters=max_iters,
                        ...
                        sample_path=sample_path, log_dir=root_log_dir, learn_rate=GAN_learn_rate, PG= fl[0],
                        t=t)

        pggan.build_model_PGGan()
        pggan.test_generate_new_images()